...
ActiveRecord::Schema.define(version: 20170408112236) do
  ...
  add_index "leave_applies", ["status"], name: "index_leave_applies_on_status", using: :btree
  add_index "leave_applies", ["user_id"], name: "index_leave_applies_on_user_id", using: :btree
